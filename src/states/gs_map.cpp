...
/******************************************************************************/
	...
	game->window.draw(*runner_animation);
}
...
/******************************************************************************/
	...
	if (runner_animation->is_mirrored == (origin.x < target.x))
		runner_animation->mirror();

	runner_animation->setPosition(path);
	runner_animation->update(dt, 0.3);
